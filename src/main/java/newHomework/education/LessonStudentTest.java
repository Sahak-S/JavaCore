package newHomework.education;

import homework.education.model.Lesson;
import newHomework.LessonStudentCommands;
import newHomework.education.model.Student;
import newHomework.education.model.User;
import newHomework.education.model.UserType;
import newHomework.education.storage.LessonStorage;
import newHomework.education.storage.StudentStorage;
import newHomework.education.storage.UserStorage;
import newHomework.education.util.DateUtil;
...
public class LessonStudentTest implements LessonStudentCommands {
        ...
        try {
            ...
            if (byEmail == null) {
                ...
                try {
                    ...
                    user.setType(author.model.UserType.valueOf(type.toUpperCase()));
    ...
    private static void printStudentByLesson() {
        ...
        newHomework.education.model.Lesson lesson = lessonStorage.getaByLessonName(lessonName);
    ...
    public static void addStudent() throws ParseException {
        ...
        List<newHomework.education.model.Lesson> lessons = new ArrayList<>();
        newHomework.education.model.Lesson lesson;
