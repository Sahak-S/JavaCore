...
import javadas.homework.education.exception.UserNotFoundException;
import javadas.homework.education.model.Lesson;
import javadas.homework.education.model.Student;
import javadas.homework.education.model.User;
import javadas.homework.education.model.UserType;
import javadas.homework.education.storage.LessonStorage;
import javadas.homework.education.storage.StudentStorage;
import javadas.homework.education.storage.UserStorage;
    ...
    private static void register() {
        ...
        try {
            ...
            if (byEmail == null) {
                ...
                System.err.println("user with " + userEmail + " already exists");
                System.err.println("օգտագործված " + userEmail + " արդեն գոյություն ունի");
            }
        }
    }
